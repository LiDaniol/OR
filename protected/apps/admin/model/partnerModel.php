...
class partnerModel extends baseModel
{
    ...
    private $customer     = 'customer';				            /* 公司信息表 */
    public $model;                                                /* 数据库操作 */
    ...
    public function edit( $comp_id, $comp_data )
    {
     ...
     /**
	 * 查询公司在数据库中是否已存在
	 * @param string $comp_name		公司名称
	 */
     
    public function is_company_exist($comp_name,$comp_id='')
    {
    	$condition = "customer_name='$comp_name'";
    	 if($comp_id!=''){
    	 	$condition.=' and id<>'.$comp_id;
    	 }
